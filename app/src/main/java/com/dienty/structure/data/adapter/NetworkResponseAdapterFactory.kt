...
class NetworkResponseAdapterFactory @Inject constructor() : CallAdapter.Factory() {
    override fun get(returnType: Type, annotations: Array<Annotation>, retrofit: Retrofit): CallAdapter<*, *>? {
        ...
        val errorBodyConverter = retrofit.nextResponseBodyConverter<Error>(null, errorBodyType, annotations)

        return NetworkResponseAdapter<Any, Error>(successBodyType, errorBodyConverter)
    }
}